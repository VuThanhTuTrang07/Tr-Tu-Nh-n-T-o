...
pipeline.fit(d_content[:800],d_label[:800])


# In[165]:


pipeline.score(d_content[800:], d_label[800:])
...
pipeline2.fit(d_content[:800],d_label[:800])

pipeline2.score(d_content[800:], d_label[800:])
